...
export function Auth() {
  ...
  return (
    <Box className="auth-layout min-h-screen w-full flex flex-col md:flex-row">
      ...
      >
        <video
          ...
          aria-hidden
        />
        <Box className="absolute inset-0 bg-eplate-charcoal/70 md:bg-eplate-charcoal/40" />
      </section>
      ...
      <section className="auth-form fixed flex-1 md:flex-3 w-full flex flex-col justify-center min-h-screen md:min-h-screen md:bg-eplate-cream backdrop-blur-xs md:backdrop-blur-none">
        <Box className="w-full flex justify-center fixed top-10">
          <img 
            src='/errePlate.iconography.landscape3 /logo-white-curved.png' alt='AIRPLATE LOGO'
          />
        </Box>
